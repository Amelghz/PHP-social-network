<div style="min-height: 400px;width:100%;background-color: white;text-align: center;">
	...
	<?php
		...
		if(isset($_GET['remove_comfirmed']) && (group_access($_SESSION['myesprims_userid'],$group_data,'admin'))){
		...
		if(isset($_GET['edit_access']) && (group_access($_SESSION['myesprims_userid'],$group_data,'admin'))){
		...
		if(isset($_GET['remove']) && (group_access($_SESSION['myesprims_userid'],$group_data,'admin'))){
