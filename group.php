<?php
	...
	$login = new Login();
	$_SESSION['myesprims_userid'] = isset($_SESSION['myesprims_userid']) ? $_SESSION['myesprims_userid'] : 0;
	
	$USER = $login->check_login($_SESSION['myesprims_userid'],false);
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(isset($_POST['first_name'])){
			...
			if(group_access($_SESSION['myesprims_userid'],$group_data,'admin')){
...
<!DOCTYPE html>
		...
		<div style="width: 800px;margin:auto;min-height: 400px;">
			...
			<div style="background-color: white;text-align: center;color: #405d9b">
				...
				<br>
					<div style="font-size: 20px;color: black;">
						...
						<br>
 							<?php if(!group_access($_SESSION['myesprims_userid'],$group_data,'member')):?>
								<?php if(!group_access($_SESSION['myesprims_userid'],$group_data,'request')):?>
				...
				<?php if(group_access($_SESSION['myesprims_userid'],$group_data,'moderator')):?>
					<?php 
			...
			<!--below cover area-->
	 		...
	 		<?php 
	 			...
	 			if($group_data['group_type'] == 'private' && !group_access($_SESSION['myesprims_userid'],$group_data,'member')){
	 				$section = "denied";
	 			}
	...
	<?php else: ?>
		...
		<div style="background-color: grey;color: white;padding: 1em;text-align: center;margin:1em;">That group was not found!
			<br><br>
			<a href="<?=ROOT?>profile/<?=$_SESSION['myesprims_userid']?>/groups">
				Go to groups
			</a>
		</div>
