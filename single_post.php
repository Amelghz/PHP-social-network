<?php 
	...
	$login = new Login();
	$user_data = $login->check_login($_SESSION['myesprims_userid']);
...
<!DOCTYPE html>
	<html>
	<head>
		<title>Single Post | MyEsprims</title>
	</head>
	...
	<body style="font-family: tahoma; background-color: #d0d8e4;">
		...
		<!--post area-->
	<?php if(!($is_group_post && $group_data['group_type'] == 'private' && !group_access($_SESSION['myesprims_userid'],$group_data,'member'))): ?>
 				...
 				<div style="min-height: 400px;flex:2.5;padding: 20px;padding-right: 0px;">
 					...
 					<div style="border:solid thin #aaa; padding: 10px;background-color: white;">
  					 ...
  					 <?php if($ROW['parent'] == 0): ?>
						...
						<?php if(!($is_group_post && $group_data['group_type'] == 'public' && !group_access($_SESSION['myesprims_userid'],$group_data,'member'))): ?>
