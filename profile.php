<?php
	...
	$user_data = $login->check_login($_SESSION['myesprims_userid'],false);
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(isset($_POST['first_name'])){
			...
			$settings_class->save_settings($_POST,$_SESSION['myesprims_userid']);
			...
			<div style="background-color: white;text-align: center;color: #405d9b">
				...
				<br>
					<div style="font-size: 20px;color: black;">
						...
						<?php if($user_data['userid'] == $_SESSION['myesprims_userid']): ?>
				...
				<?php 
					if($user_data['userid'] == $_SESSION['myesprims_userid']){
